package com.sunchaser.shushan.mojian.uploader.impl.kodo;
...
import com.sunchaser.shushan.mojian.uploader.AbstractUploader;
import com.sunchaser.shushan.mojian.uploader.exception.MoJianUploaderException;
...
public class QiNiuCloudUploader extends AbstractUploader {
    ...
    protected String doUpload(MultipartFile multipartFile, String fileUri) throws Exception {
        try {
            UploaderProperties.QiNiu qiniu = this.uploaderProperties.getQiniu();
